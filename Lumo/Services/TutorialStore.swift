...
enum TutorialHint: String, CaseIterable, Identifiable {
    ...
    var titleKey: String {
        ...
        case .twoGates: return "One of these gates kills"
    ...
    var bodyKey: String {
        ...
        case .twoGates: return "There is a second gate beside the path, and it is RED. It looks like a way out and it is not — touching it throws you back to the start of the level and every star you had collected goes back too. Red has meant one thing since the very first level, and it still does here. Only the green gate finishes the level."
