...
enum TutorialHint: String, CaseIterable, Identifiable {
    ...
    var bodyKey: String {
        ...
        case .twoGates: return "There is a second gate beside the path, and it is RED. It looks like a way out and it is not — touching it ends the attempt. Red has meant one thing since the very first level, and it still does here. Only the green gate finishes the level."
